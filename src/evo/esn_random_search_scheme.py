...
from src.evo.random_seach_scheme import RandomSearchScheme
from src.evo.esn_data_holder import EsnDataHolder


class EsnRandomSearchScheme(RandomSearchScheme):
    def __init__(self,
        name: str,
        scheme_cfg: cfg.RandomSearchSchemeSchemeConfigField,
        ...
        # Init configs
        self._scheme_cfg: cfg.EsnConfigField = scheme_cfg
    ...
    def save(self,
        **kvargs,
        ...
        if not kvargs.get('disable_dump_graph_best', False):
            ...
            fig.savefig(f'{self._runpool_dir}/graph_best.png', dpi=fig.dpi)
