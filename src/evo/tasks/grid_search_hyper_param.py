...
from src.evo.esn_grid_search_scheme import EsnGridSearchScheme
...
class GridSearchHyperParam(EsnGridSearchScheme):
    def __init__(self,
        scheme_cfg: cfg.HyperParamGridSearchConfig,
        ...
        super().__init__(
            name='hyper_param',
            scheme_cfg=self._scheme_cfg.GridSearch,
