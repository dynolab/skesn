...
from src.evo.evo_esn_scheme import EvoEsnScheme, EsnDataHolder
...
class DynoEvoEsnHyperParam(EvoEsnScheme):
    def __init__(self,
        ...
        self._cfg = cfg
        self._model = evo_utils.create_model_by_type(self._cfg.Evaluate.Model)

        esn_data_holder = EsnDataHolder(self._model)
