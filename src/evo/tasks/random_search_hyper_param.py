...
from src.evo.esn_random_search_scheme import EsnRandomSearchScheme
...
class RandomSearchHyperParam(EsnRandomSearchScheme):
    def __init__(self,
        scheme_cfg: cfg.HyperParamRandomSearchConfig,
        ...
        super().__init__(
            name='hyper_param',
            scheme_cfg=self._scheme_cfg.RandomSearch,
